...
const user = (req, res) => {
  ...
  Publication.find({ "user": userId })
    ...
    .populate("user", '-password -__v -role -email')//Populate trate el objeto a travez de su id
...
const feed = async (req, res) => {
  ...
  //sacar array de identificadores de usuarios que yop sigo como usuario logueado
  try {
